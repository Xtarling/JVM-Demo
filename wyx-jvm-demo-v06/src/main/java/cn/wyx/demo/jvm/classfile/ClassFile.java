...
public class ClassFile {
    ...
    private final int thisClassIdx;           //此类的全限定名索引
    private final int superClassIdx;          //父类的全限定名索引
    private final int[] interfaces;           //接口索引集合
    private final MemberInfo[] fields;        //字段表集合
    private final MemberInfo[] methods;       //方法表集合
    private final AttributeInfo[] attributes; //属性表集合
