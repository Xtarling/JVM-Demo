...
public class LocalVars {
    ...
    public Float getFloat(int idx) { //float?
    ...
    public Long getLong(int idx) { //long?
    ...
    public Double getDouble(int idx) { //double?
        return Double.valueOf(getLong(idx)); //getLong(idx)不需要强制类型转换吗？
    }
